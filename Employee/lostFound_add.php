<title>CCP SO System | New lost item</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">New lost item</li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="card">
              ...
              <div class="card-body p-3">
                <form action="process_save.php" method="POST" enctype="multipart/form-data">
                  <div class="row">
                    <input type="hidden" class="form-control"  placeholder="Name of the Owner" name="reporterId" required value="<?php echo $id; ?>">   
                    <div class="col-lg-6">
                        <div class="form-group">
                          <span class="text-dark"><b>Name of the Owner</b></span>
                          <input type="text" class="form-control"  placeholder="Name of the Owner" name="ownername" required>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                          <span class="text-dark"><b>Ownder contact details(Contact no./ Email)</b></span>
                          <input type="text" class="form-control"  placeholder="Ownder contact details" name="contact" required>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                          <span class="text-dark"><b>Date lost</b></span>
                          <input type="date" class="form-control"  placeholder="Date lost" name="datelost" required>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="form-group">
                          <span class="text-dark"><b>Item name</b></span>
                          <input type="text" class="form-control"  placeholder="First name" name="itemname" required>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                          <span class="text-dark"><b>Description of the item</b></span>
                          <textarea name="description" id="" cols="30" rows="5" class="form-control" placeholder="Description of the item"></textarea>
                        </div>
                    </div>
              ...
              <div class="modal-footer alert-light">
                ...
                <button type="submit" class="btn bg-gradient-primary" name="create_item"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
              </div>
              </form>
            </div>
          </div>
