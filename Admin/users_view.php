<title>CCP SO System | Student Info</title>
<?php 
            ...
            <div class="card">
              ...
              <div class="card-body p-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                      <div class="form-group">
                          <span class="text-dark"><b>Coures and Year</b></span>
                          <input type="text" class="form-control"  placeholder="Year level" name="level" required value="<?php echo ' '.$row['course'].' - '.$row['level'].' '; ?>" readonly>
                        </div>
                    </div>
                  </div>
                  <div class="row">
              ...
              <div class="modal-footer alert-light">
                ...
                <a href="users_update.php?user_Id=<?php echo $row['user_Id']; ?>" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> Edit</a>
              </div>
