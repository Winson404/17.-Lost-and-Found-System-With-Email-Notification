<title>CCP SO System | Update administrator</title>
<?php 
          ...
          <div class="col-md-12">
            <div class="card">
                  ...
                  <div class="row">
                        <div class="col-lg-6 mb-3">
                          ...
                          <select class="form-control" name="usertype" required>
                            ...
                            <!-- <option value="Non-admin" <?php //if($row['user_type'] == 'Non-admin') { echo 'selected'; } ?>>Non-admin</option> -->
                        </select>
                    </div>
                    ...
                    <div class="col-lg-8">
                          <div class="form-group">
                            ...
                            <!-- <p class="help-block text-danger">5MB</p> -->
                          </div>
                      </div>
                      <!-- LOAD IMAGE PREVIEW -->
                      <div class="col-lg-4">
              ...
              <div class="modal-footer alert-light">
                <a href="admin.php" class="btn btn-secondary"><i class="fa-solid fa-circle-left"></i> Back to List</a>
                <button type="submit" class="btn bg-gradient-primary" name="update_admin"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
              </div>
              </form>
            </div>
          </div>
