<title>CCP SO System | Administrator</title>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header p-2">
                <a href="admin_add.php" class="btn btn-sm bg-primary ml-2"><i class="fa-sharp fa-solid fa-square-plus"></i> New Administrator</a>
                      ...
                      ?>
                        ...
                        <td>
                          <?php if($row['user_type'] == 'Admin'): ?>
                            <span class="badge badge-primary mt-1"><?php echo $row['user_type']; ?></span>
                          <?php else: ?>
                            <span class="badge badge-secondary mt-1"><?php echo $row['user_type']; ?></span>
                          <?php endif; ?>
                        </td>
                        <td>
                          <a href="admin_view.php?user_Id=<?php echo $row['user_Id']; ?>" class="btn btn-primary btn-sm"><i class="fas fa-folder"></i></a>
                          <a href="admin_update.php?user_Id=<?php echo $row['user_Id']; ?>" class="btn btn-success btn-sm"><i class="fas fa-pencil-alt"></i></a>
