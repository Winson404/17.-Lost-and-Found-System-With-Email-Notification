<title>CCP SO System | Administrator Info</title>
<?php 
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="modal-footer alert-light">
                ...
                <a href="admin_update.php?user_Id=<?php echo $row['user_Id']; ?>" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> Edit</a>
              </div>
