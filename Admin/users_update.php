<title>CCP SO System | Update Student</title>
<?php 
          ...
          <div class="col-md-12">
            <div class="card">
                   ...
                   <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <?php if($row['Id_Number'] != ''): ?>
                            <input type="number" class="form-control"  placeholder="ID Number" name="idnumber" required value="<?php echo $row['Id_Number']; ?>" readonly>
                          <?php else: ?>
                            <input type="number" class="form-control"  placeholder="ID Number" name="idnumber" required value="<?php echo $row['Id_Number']; ?>" >
                          <?php endif; ?>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control"  placeholder="Year level" name="level" required value="<?php echo $row['level']; ?>">
                        </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
              ...
              <div class="modal-footer alert-light">
                ...
                <button type="submit" class="btn bg-gradient-primary" name="update_user"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
              </div>
              </form>
            </div>
          </div>
